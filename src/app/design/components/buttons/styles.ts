...
const generateButtonTheme = ({
  ...
  border,
  color,
}: GenerateButtonThemeOptions) => css`
  background: ${background};
...
const outlinedButtonStyles = ({
  ...
  focus: generateButtonTheme({
    background: transparent,
    border: transparent,
    color: base,
  }),
  hover: generateButtonTheme({
    background: hover,
    border: hover,
    color: white,
  }),
...
export const generateButtonStyle = ({
  shape,
  theme,
}: GenerateButtonStyleOptions) => css`
